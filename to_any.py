def transform(innitvar, basevar, convertvar):
    accepted = {
            '0': 0,
            '1': 1,
            '2': 2,
...
if __name__ == "__main__":
    while True:
        ...
        c = int(input("Please enter the base that you would like to convert to: "))

        transform(innitvar=a, basevar=b, convertvar=c)
